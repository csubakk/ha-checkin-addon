...
MQTT_PORT = 1883
MQTT_USER = "fastapi"
MQTT_PASSWORD = "Qujnir-novjov-koqta0"
MQTT_TOPIC = "tapexpert/checkin_done"
...
async def submit_guest_data(
    ...
    try:
        ...
        print(f"✅ MQTT üzenet elküldve: {MQTT_TOPIC} – {token}")
    except Exception as e:
        print(f"❌ MQTT hiba: {e}")

    return {"status": "ok", "message": "Adatok frissítve és MQTT jelzés elküldve."}
